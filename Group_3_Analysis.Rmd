...
index_val_b <- same_sample((1:nrow(imdb))[-index_train], round(0.25*nrow(imdb)))
index_test_b <- setdiff(1:nrow(imdb),c(index_val,index_train))

test_imdb_b <- imdb_dummy[index_test_b,]
index_val_b <- imdb_dummy[index_val_b,]
